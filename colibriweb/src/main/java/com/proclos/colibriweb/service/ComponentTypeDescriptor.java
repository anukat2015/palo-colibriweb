...
public class ComponentTypeDescriptor {
	...
	private String[] allowedConnectionTypes;
	...
	/**
	 * return the list of connections that are allowed to be used in this component.
	 * The result can be either a normal list greater or equal to 1 
	 * or null (or array with one null entry) if no connections are allowed 
	 * or an array with one entry with value "*" which means all connection types. 
	 * @return null or a list or types or a array with single entry with value "*"
	 */
	...
	/**
	 * Set the list of connections that are allowed to be used in this component.
	 * This can be either a normal list greater or equal 1 
	 * or null if no connections are allowed 
	 * or an array with one entry with value "*" which means all connection types. 
	 * @param allowedConnectionTypes
	 */
	public void setAllowedConnectionTypes(String[] allowedConnectionTypes) {
