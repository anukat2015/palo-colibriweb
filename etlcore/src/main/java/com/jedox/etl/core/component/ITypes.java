...
public interface ITypes {
	...
	public static enum Components {
		...
		public static boolean contains(String component){
			try{
				valueOf(component);
				return true;
			}catch(Exception e){
	...
	public static enum Managers {
		...
		public static boolean contains(String manager){
			try{
				valueOf(manager);
				return true;
			}catch(Exception e){
	...
	public static enum MainManagers {
		connections, extracts, transforms, loads, jobs, variables, headers;
