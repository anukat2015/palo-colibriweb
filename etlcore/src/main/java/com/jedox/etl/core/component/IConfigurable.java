...
/**
 * Interface, which supports a notification mechanism, where all registered listener objects get notified on a change in configuration and may react properly.
...
public interface IConfigurable {
	...
	/**
	 * Adds a listener to be notified on config change
	 * @param listener any object implementing the IConfigurationChangeListener interface
	 */
	public void addConfigurationChangeListener(IConfigurationChangeListener listener);
	
	/**
	 * Adds multiple IConfigurationChangeListeners
	 * @param listeners an array of IConfigurationChangeListener
	 */
	...
	/**
	 * Gets all ConfigurationChangeListeners 
