 ...
 *
 */
public interface IFileConnection extends IStreamWritable, IStreamReadable, IRelationalConnection {
	 ...
	 * @return
	 */
	public IFileWriter getWriter(boolean append) throws RuntimeException;
	...
	public String getExternalParameter(String key, String defaultValue);
