...
public interface IContext extends IComponent {
	...
	/**
	 * Sets an ExecutionState, which holds all data and meta data of the execution. If an execution is terminated (externally or by an internal error) this state receives notification. 
	 * @param state the ExecutionState
	 */
	public void setState(ExecutionState state);
	
	/**
	 * gets the ExecutionState of this executable
	 * @return the Execution State
	 */
	public ExecutionState getState();
	
	/**
	 * Determines if the execution should be terminated. Requires an ExecutionState to be set. 
	 * @return true if the component should process executing, false if it should terminate
	 */
