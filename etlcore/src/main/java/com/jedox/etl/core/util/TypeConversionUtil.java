...
public class TypeConversionUtil {
	...
	private static Class<?> lookupPrimitive(String name)
	{
	...
	public static Object convert(IColumn column) throws RuntimeException {
		...
		if (value == null) 
			return null;
		if (IPersistable.class.isAssignableFrom(value.getClass())) {
			return value;
		}
		if (clazz.equals(String.class)) {
			NamedValue<Object> temp = new NamedValue<Object>(null,value);
			return temp.getValueAsString();
		}
		try {
