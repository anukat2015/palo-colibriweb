...
public class XMLTreeManager implements IDimension {
	...
	public void appendElements(IElement[] arg0) throws PaloException,
			PaloJException {
		throw new PaloException("Not supported by XML provider");
	}
	...
	public IElement[] getElementsByName(String[] arg0, boolean arg1)
		...
		List<IElement> result = new ArrayList<IElement>();
		for (String s : arg0) {
			result.add(getElementByName(s, arg1));
		}
		return result.toArray(new IElement[result.size()]);
	}
	...
	@Override
	public IAttribute addAttribute(String name, ElementType type)
			throws PaloJException, PaloException {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public IElement getSingleElement(String elementName, boolean withAttributes)
			throws PaloException, PaloJException {
		// TODO Auto-generated method stub
		return getElementByName(elementName, withAttributes);
	}
