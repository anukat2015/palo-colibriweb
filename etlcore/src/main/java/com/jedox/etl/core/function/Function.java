...
public abstract class Function extends Component implements IFunction {
	...
	protected static enum Types {
		tDouble, tInteger, tLong, tByte, tFloat, tShort, tString, tObject, tint, tdouble, tbyte, tfloat, tshort, tlong, tDate, tboolean, tBoolean
	}
		...
		for (int i=0; i<inputTypes.length; i++) {
			if (inputTypes[i]==null) {
				...
				switch (t) { //first test for primitives then for classes.
					...
					case tfloat: classes[i] = Float.TYPE; break;
					...
					case tDate: classes[i] = Date.class; break;
					case tBoolean: classes[i] = Boolean.class; break;
					case tObject: classes[i] = Object.class; break;
