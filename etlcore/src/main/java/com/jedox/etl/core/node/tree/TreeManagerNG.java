...
*/		
	...
	@Override
	public void appendElements(IElement[] elements) throws PaloException,
			PaloJException {
		// TODO Auto-generated method stub
		for (IElement e : elements) {
			Element internal = provideElement(e);
			internal.setValue(e.getType());
		}
	}
