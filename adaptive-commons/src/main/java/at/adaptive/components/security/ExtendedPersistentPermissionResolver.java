...
@Startup
public class ExtendedPersistentPermissionResolver implements PermissionResolver, Serializable
{
	...
	public boolean hasPermission(Object target, String action)
	{
		...
		for(Permission permission : permissions)
		{
			...
			if(permission.getRecipient() instanceof SimplePrincipal && !(permission.getRecipient() instanceof Role) && username.equals(permission.getRecipient().getName()))
			{
				return true;
			}
		}
