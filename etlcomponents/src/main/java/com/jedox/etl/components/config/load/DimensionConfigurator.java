...
public class DimensionConfigurator extends LoadConfigurator {
	...
	public boolean deactivateRules() throws ConfigurationException {
		boolean deactivateRules = false;
		Element dimension = getXML().getChild("dimension");
		if (dimension != null) {
			deactivateRules = Boolean.valueOf(dimension.getAttributeValue("deactivateRules","false"));
		}
	...
	public int getElementBulkSize() throws ConfigurationException {
		return Integer.parseInt(getParameter("elementBulkSize",String.valueOf(10000)));
	}
	
	public int getAttributeBulkSize() throws ConfigurationException {
		return Integer.parseInt(getParameter("attributeBulkSize",String.valueOf(10000)));
	}		

	// not used anymore
	public int getConsolidateBulkSize() throws ConfigurationException {
