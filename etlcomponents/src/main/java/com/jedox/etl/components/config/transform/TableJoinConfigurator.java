...
public class TableJoinConfigurator extends TableSourceConfigurator implements
	...
	public class JoinDefinition {
		...
		public JoinDefinition clone() {
			JoinDefinition result = new JoinDefinition(leftSource, rightSource, type);
	...
	public List<JoinDefinition> getJoins() throws ConfigurationException {
		...
		for (Element join : joins) {
			...
			if(leftkeys.size()!=rightkeys.size()){
				throw new ConfigurationException("Number of left keys should be equal to the number of right keys.");
			}
			if(leftkeys.size()<conditions.size()){
				throw new ConfigurationException("Number of conditions should be less or equal to the number of keys.");
			}
