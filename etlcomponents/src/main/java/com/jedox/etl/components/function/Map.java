...
public class Map extends Function {
	...
	protected void validateParameters() throws ConfigurationException {
		...
		try {
			type = Class.forName(getParameter("type",String.class.getCanonicalName()));
		} catch (ClassNotFoundException e) {
			throw new ConfigurationException("Type "+ getParameter("type",String.class.getCanonicalName()) + " not found.");
		}
	}
