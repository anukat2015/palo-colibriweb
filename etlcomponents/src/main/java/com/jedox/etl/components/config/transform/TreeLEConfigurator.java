...
public class TreeLEConfigurator extends TreePCConfigurator implements
		ITransformConfigurator {

		protected Row setColumns() throws ConfigurationException {
		Row manager = new Row();
		setCoordinate(manager,getTarget().getChild("level"),NamingUtil.getElementnameLevel());
		setCoordinate(manager,getTarget().getChild("element"),NamingUtil.getElementnameChild());
