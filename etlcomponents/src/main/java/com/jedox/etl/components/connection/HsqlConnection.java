...
public class HsqlConnection extends RelationalConnection {
	...
	protected String getConnectionString(String parametersStr) {
		...
		if (!parametersStr.contains("shutdown=")) {
			connectionString += "shutdown=true;";
		}	
		if (!parametersStr.isEmpty()) {
			connectionString += parametersStr;
		}		
